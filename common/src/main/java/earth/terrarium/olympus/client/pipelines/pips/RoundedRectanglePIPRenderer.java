...
public class RoundedRectanglePIPRenderer extends PictureInPictureRenderer<RoundedRectanglePIPRenderer.State> implements PipPipelineHelper {
    ...
    protected void renderToTexture(
        ...
        PipelineSubmit.builder(RoundedRectangle.PIPELINE).vertices(
            DefaultVertexFormat.POSITION_COLOR, PrimitiveTopology.QUADS, bufferBuilder -> {
            ...
            RoundedRectangleUniform.STORAGE, RoundedRectangleUniform.of(
                new Vector4f(
                ...
                scale)).submit(submitNodeCollector);
